...
export default function OpticalErrorBoundary({ error, reset }: ErrorProps) {
	useEffect(() => {
		console.error("MNOC-X Optical Module Error Caught by Boundary:", error);
	}, [error]);
	...
	return (
		<div className="min-h-[500px] h-full w-full flex items-center justify-center p-6 bg-zinc-200 dark:bg-zinc-950">
			<div className="max-w-lg w-full rounded-2xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 shadow-xl p-6 sm:p-8 space-y-6">
				...
				<div className="text-xs text-zinc-600 dark:text-zinc-400 space-y-1">
					...
					<ul className="list-disc list-inside space-y-0.5 text-[11px] text-zinc-500">
						<li>Clique em <strong>Recarregar Módulo</strong> para tentar reestabelecer o estado.</li>
